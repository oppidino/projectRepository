...
import it.cocacola.championshiprace.constants.ChampionshipraceConstants;



/**
 * This is the extension manager of the Championshiprace extension.
 */
public class ChampionshipraceManager extends GeneratedChampionshipraceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ChampionshipraceManager.class.getName());
	 ...
	 */
	public static ChampionshipraceManager getInstance()
	{
		return (ChampionshipraceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChampionshipraceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChampionshipraceManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChampionshipraceManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChampionshipraceManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChampionshipraceManager called, current tenant: " + getTenant().getTenantID());
		}
	}
