...
/**
 * This is the extension manager of the Championship extension.
 */
public class ChampionshipManager extends GeneratedChampionshipManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ChampionshipManager.class.getName());
	...
	{
		return (ChampionshipManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChampionshipConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChampionshipManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChampionshipManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChampionshipManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChampionshipManager called, current tenant: " + getTenant().getTenantID());
		}
	}
