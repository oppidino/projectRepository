 ...
 *  
 */
package it.cocacola.championshipfrontend.jalo;
...
import it.cocacola.championshipfrontend.constants.ChampionshipfrontendConstants;



/**
 * This is the extension manager of the Championshipfrontend extension.
 */
public class ChampionshipfrontendManager extends GeneratedChampionshipfrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ChampionshipfrontendManager.class.getName());
	 ...
	 */
	public static ChampionshipfrontendManager getInstance()
	{
		return (ChampionshipfrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChampionshipfrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChampionshipfrontendManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChampionshipfrontendManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChampionshipfrontendManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChampionshipfrontendManager called, current tenant: " + getTenant().getTenantID());
		}
	}
